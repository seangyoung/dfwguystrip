...
function photoFor(activity: Activity) {
  ...
  if (['whataburger'].includes(activity.id)) return 'https://dynl.mktgcdn.com/p/6HPZgDXrbAqT6KS8grSNv07v2ktxdKkwvuJ-CUL8lzA/1900x633.jpg'
  if (['uptown-eats'].includes(activity.id)) return 'https://foodtoursofamerica.com/wp-content/uploads/2024/06/McKinney-Avenue-Trolley.webp'
  if (['moviehouse-eatery'].includes(activity.id)) return 'https://indy-systems.imgix.net/4zyoz11kxd939bgg5bzju8rhv39g?max-w=1000&fit=fill&auto=format'
